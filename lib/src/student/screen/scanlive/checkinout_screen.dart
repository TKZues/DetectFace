...
import 'package:findy/src/student/screen/scanlive/test/test2.dart';
...
class _CheckInOutScreenState extends State<CheckInOutScreen>
  ...
  Widget _checkinTab(AttendanceRepositories repo) {
    return Padding(
  ...
  Widget _checkoutTab(AttendanceRepositories repo) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: psHeight(20)),
      child: SingleChildScrollView(
        child: Column(
