...
class NotificationSocketItem extends StatefulWidget {
  final String monhoc;
  final String thongbao;
  final String? thoigian;
  const NotificationSocketItem({
    super.key,
  ...
  @override
  State<NotificationSocketItem> createState() => _NotificationSocketItemState();
}

class _NotificationSocketItemState extends State<NotificationSocketItem> {
