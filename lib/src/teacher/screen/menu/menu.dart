...
import 'package:findy/src/teacher/screen/menu/achievement/level_achievement.dart';
import 'package:findy/src/teacher/screen/menu/achievement/medal_achievement.dart';
import 'package:findy/src/teacher/screen/menu/information/contact_information.dart';
import 'package:findy/src/teacher/screen/menu/information/course_information.dart';
import 'package:findy/src/teacher/screen/menu/information/general_information.dart';
import 'package:findy/src/teacher/screen/menu/stat/card_menu.dart';
import 'package:findy/src/teacher/screen/menu/stat/notification_general.dart';
...
class _MenuAppState extends State<MenuApp> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      final repo = context.read<NotificationRepositories1>();
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider.value(
      value: context.read<NotificationRepositories1>(),
      child: ProgressHUD(
        child: Scaffold(
          ...
          body: ConsumerBase<NotificationRepositories1>(
            onRepository: (rp) {
              return Column(
                children: [
                  TabBar(
  ...
  Widget _tabSTATS(NotificationRepositories1 repo) {
    List piedata = [
  ...
  Widget _tabACHIEVEMENT(NotificationRepositories1 repo) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 15, vertical: 10),
      child: SingleChildScrollView(
        child: Column(
