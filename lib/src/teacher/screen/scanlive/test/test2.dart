...
class _UnifiedCapturePageState extends State<UnifiedCapturePage> {
  ...
  Future<void> takePicture(DetectFaceLiveRepositories1 repository) async {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider.value(
      value: context.read<DetectFaceLiveRepositories1>(),
      child: ProgressHUD(
        child: Scaffold(
          floatingActionButton: FloatingActionButton(
            ...
            onPressed: () async {
              final repository = Provider.of<DetectFaceLiveRepositories1>(
                  context,
                  listen: false);
          ...
          body: ConsumerBase<DetectFaceLiveRepositories1>(
