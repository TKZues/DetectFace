...
import 'package:findy/src/teacher/model/timeline_model.dart';
...
class TimelineRepositories1 extends BaseRepository<TimelineServices1> {
  TimelineRepositories1(super.service);
