...
class DetectFaceLiveRepositories1 extends BaseRepository<DetectFaceLiveService1> {
  DetectFaceLiveRepositories1(super.service);
    ...
    try {
      ...
      if (res.statusCode == 200) {
        if (res.data['results'] != null && res.data['results'].isNotEmpty) {
          CustomSnackbar.snackbarSuccess(res.data['results'][0]['label'] +
