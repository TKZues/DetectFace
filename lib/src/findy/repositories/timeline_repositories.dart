...
import 'package:findy/src/findy/model/timeline_model.dart';
        ...
        for (final data in res.data['data']) {
          ...
          if (timelineItem.curriculumName != null) {
            ...
            Appointment meetingData = Appointment(
              ...
              startTime: DateTime(
                  parsedDate.year, parsedDate.month, parsedDate.day, parsedStartTime.hour, parsedStartTime.minute, 0),
              endTime: DateTime(parsedDate.year, parsedDate.month,
                      parsedDate.day, parsedEndTime.hour, parsedEndTime.minute, 0)
